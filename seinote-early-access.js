(function () {
  ...
  const translations = {
    en: {
      ...
      hero_lead: "Clinical notes, scheduling, video sessions, billing and marketing in one calmer workspace for mental health professionals. Seinote helps independent practices reduce scattered admin and keep the day moving with more clarity.",
      ...
      problem_p1: "Notes, billing, reminders and scheduling can quietly take over the day.",
      problem_p2: "Seinote helps bring the work back into one clear flow.",
    ...
    fr: {
      ...
      hero_lead: "Notes cliniques, horaire, séances vidéo, facturation et marketing dans un espace de travail plus calme. Seinote aide les pratiques indépendantes à réduire l'administration dispersée et à garder la journée plus claire.",
      ...
      problem_p1: "Les notes, la facturation, les rappels et l'horaire peuvent vite prendre trop de place.",
      problem_p2: "Seinote aide à ramener ce travail dans un flux plus clair.",
