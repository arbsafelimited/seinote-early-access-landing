(function () {
  ...
  const translations = {
    en: {
      ...
      hero_lead: "Clinical notes, scheduling, video sessions and billing in one calmer workspace for mental health professionals.",
    ...
    fr: {
      ...
      hero_lead: "Notes cliniques, horaire, séances vidéo et facturation dans un espace de travail plus calme.",
